    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/modifiermat">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="nom_materiel" type="text" class="form-control @error('nom_materiel') is-invalid @enderror" name="nom_materiel" value="{{$materiel->nom_materiel}}" required autocomplete="nom_materiel" autofocus>
